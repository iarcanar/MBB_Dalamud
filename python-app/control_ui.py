...
class Control_UI:
    ...
    def create_toggle_switch(self, parent, text, variable, command, width=40, height=20):
        ...
        bg_color = current_theme.get("bg", "#0a0a0f")  # Cyberpunk: very dark background
        ...
        bg_on_color = current_theme.get("success", "#00FF88")  # Cyberpunk: green-cyan
        bg_off_color = current_theme.get("button_inactive_bg", "#2a2a3e")  # Cyberpunk: dark blue-gray
        knob_color = current_theme.get("fg", "#FFFFFF")  # Cyberpunk: white
        bg_outline = current_theme.get("border", "#00FFFF")  # Cyberpunk: cyan border
    ...
    def toggle_click_translate(self, value):
        ...
        if force_button:
            if value:
                ...
                force_button.config(bg=self.theme.get("error", "#FF1493"))  # Cyberpunk: deep pink error
                ...
                force_button.config(bg=self.theme.get("accent", "#00FFFF"))  # Cyberpunk: cyan
    ...
    def _on_force_button_hover_enter(self, event: tk.Event) -> None:
        ...
        try:
            ...
            if time_diff >= self._force_cooldown_period:
                ...
                highlight_bg = self.theme.get("error", "#FF1493")  # Cyberpunk: deep pink error
    ...
    def _on_force_button_hover_leave(self, event: tk.Event) -> None:
        ...
        try:
            ...
            if hasattr(self, "_force_button_original_bg"):
                ...
                self.force_button.configure(
                    bg=self.theme.get("button_bg", "#1a1a2e"),  # Cyberpunk: dark blue
    ...
    def show_force_feedback(self):
        ...
        try:
            ...
            feedback.configure(bg=self.theme.get("bg", "#0a0a0f"))  # Cyberpunk: very dark
            feedback.attributes("-alpha", 0.9)
            feedback.attributes("-topmost", True)

            # ใช้สีพื้นหลังจาก theme
            bg_color = self.theme.get("bg", "#0a0a0f")  # Cyberpunk: very dark
            border_color = self.theme.get("accent", "#00FFFF")  # Cyberpunk: cyan
