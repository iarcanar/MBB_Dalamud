...
class FontUI:
    ...
    def show_font_installation_dialog(self):
        ...
        for font in uninstalled_fonts:
            ...
            status_color = "#f44336" if not font["installed"] else appearance_manager.get_theme_color("accent", "#00FFFF")
        ...
        install_button = tk.Button(
            ...
            font=("IBM Plex Sans Thai Medium", 11),
            bg=appearance_manager.get_theme_color("accent", "#00FFFF"),
            fg="#e0e0e0",
            padx=15,
            pady=8,
            bd=0,
    ...
    def apply_font(self) -> None:
        ...
        try:
            ...
            self.show_temporary_notification(
                ...
                color=appearance_manager.get_theme_color("accent", "#00FFFF"),
                duration=3000,
            )
    ...
    def create_notification_area(self) -> None:
        ...
        self.notification_label = tk.Label(
            ...
            bg="#2e2e2e",
            fg=appearance_manager.get_theme_color("accent", "#00FFFF"),
            wraplength=380,
        )
        self.notification_label.pack(fill=tk.BOTH, expand=True)

    def show_temporary_notification(
        self, message, color=None, duration=2000
    ) -> None:
    ...
    def validate_selected_font(self):
        ...
        if validation["status"] == "success":
            self.validation_status.config(
                text=f"✅ ฟอนต์ {font_name} สามารถโหลดได้ถูกต้อง", fg=appearance_manager.get_theme_color("accent", "#00FFFF")
            )
            ...
            if has_thai:
                self.thai_support_indicator.config(text="✅ รองรับภาษาไทย", fg=appearance_manager.get_theme_color("accent", "#00FFFF"))
            else:
                self.thai_support_indicator.config(
