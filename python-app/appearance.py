...
class AppearanceManager:
    def __init__(self):
        self.bg_color = "#0a0a0f"  # Cyberpunk: very dark background
        self.fg_color = "#FFFFFF"  # Cyberpunk: white text
        self.highlight_color = "#00FFFF"  # Cyberpunk: bright cyan
        self.opacity = 0.9
    ...
    def create_cyber_border(self, canvas, x1, y1, x2, y2, width=2, corner_size=10):
        """Draw cyberpunk-style geometric border with corner accents
        ...
        Args:
            ...
            corner_size: Size of corner accent lines (default: 10)

        Returns:
            list: IDs of created canvas items
        """
        border_color = self.get_theme_color("border", "#00FFFF")
        items = []
        ...
        # Draw corner accents (L-shapes at each corner)
